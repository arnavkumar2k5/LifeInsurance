  ...
  return (
    <div className="flex flex-col justify-center m-auto pt-20 md:pt-40 items-center p-5 md:p-40 bg-white">
      ...
      <div className="flex flex-wrap justify-center items-center mt-10 md:mt-20 gap-5 md:gap-10 text-xs md:text-sm">
        <div className="border-4 w-full md:w-[48%] border-gray-200 p-5 md:p-10">
          <p className="text-lg md:text-xl font-semibold mb-5 md:mb-10">Term insurance</p>
          <p>
        ...
        <div className="border-4 w-full md:w-[48%] p-5 md:p-10 border-gray-200">
          <p className="text-lg md:text-xl font-semibold mb-5 md:mb-10">Permanent insurance</p>
          <p>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-5 md:gap-20 mt-20 md:mt-40 w-full md:w-auto">
        <div className="text-xs md:text-sm text-center md:text-left">
          ...
          <p>Not sure what's right for you? An advisor can explain all your insurance</p>
          <p className="w-full md:w-[98%]">
            options and help you figure out which products meet your needs and goals.
          </p>
          <button className="bg-cyan-500 text-white mt-5 md:mt-10 p-2 md:p-3 pl-5 pr-5 md:pl-7 md:pr-7 rounded-full">
            Schedule Call
          </button>
        </div>

        <div className="text-xs md:text-sm text-center md:text-left mt-5 md:mt-[4.8rem]">
          <p>Answer a few quick questions to get a quote for coverage up to</p>
          <p>$1,000,000.</p>
          <button className="bg-cyan-500 text-white mt-5 md:mt-[3.7rem] p-2 md:p-3 pl-5 pr-5 rounded-full">
            Get a quote Online
          </button>
        </div>
      </div>
